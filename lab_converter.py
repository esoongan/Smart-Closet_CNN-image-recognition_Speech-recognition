...
class ColorConverter:
    ...
    def __init__(self, colors_path='/Users/hayeong/Smart-Closet/data/final_name_lab.txt'):
    ...
    def lab_to_name(self, lab):
        ...
        for i in range(len(self.color_list)):
            ...
            if d < min_d:
                ...
                index = i
        # 가장 근접한 색상명 리턴
        #print('input(L,a,b):',lab)
        #print('output(l,a,b):', self.color_list[index][1])
        #print('distance:',min_d)
        return self.color_list[index][0]

#c = cvt.lab_to_name((97.138, -21.556, 94.482))
#print(c)

#print(cvt.lab_to_name((53.233, 80.109, 67.220)))
